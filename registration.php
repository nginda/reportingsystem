		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">OB Number</p><input type="text"  name="OB_number" minlength="2" maxlength="12" id="aadh" onfocusout="f1()"/>
					...
					<div class="right-agileits">
						<p style="color:#dfdfdf">Mobile</p><input type="text"  name="mobile_number" required  minlength="10" maxlength="10" id="mobno" onfocusout="f1()"/>
					</div>
